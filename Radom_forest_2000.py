...
combined_df = pd.DataFrame({
    'SP500': hist,
    'Volatilidad': vol,
    'Bonos_10_Anos': dgs10_df['Precio_Bonos_10'],
    'Oro': o,
    'DXY': div,
...
# 3. Preparación de datos para el RF
...
plt.title('Matriz de Confusión RF 2000')
...
plt.title('Top 15 Features Random Forest 2000')
plt.show()
...
plt.title('Caídas Reales vs Predichas RF 2000')
...
plt.title('Caídas Reales vs Predichas (Febrero - Mayo 2020) RF 2000')
plt.legend()
plt.xlabel('Fecha')
...
plt.title("ACF de los residuos del modelo RF 2000")
plt.tight_layout()

# PACF de los residuos
plt.subplot(1, 3, 2)
plot_pacf(residuals, lags=30, method='ywm', ax=plt.gca())
plt.title("PACF de los residuos del modelo RF 2000")
plt.tight_layout()

plt.subplot(1, 3, 3)
sns.histplot(residuals, kde=True)
plt.title("Distribución de Residuos RF 2000")
plt.tight_layout()
plt.show()
...
plt.title('Training vs Validation ROC AUC RF 2000')
plt.legend()
plt.grid(True)
plt.show()
...
plt.title('Permutation Feature Importance - Random Forest 2000')
plt.tight_layout()
plt.show()