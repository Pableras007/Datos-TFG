...
plt.title('Training and Validation Loss LSTM 2007')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
...
plt.title('Training and Validation AUC LSTM 2007')
plt.xlabel('Epochs')
plt.ylabel('AUC')
plt.legend()
...
plt.title('Training and Validation Precision LSTM 2007')
plt.xlabel('Epochs')
...
plt.title('Training and Validation Accurancyl LSTM 2007')
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.legend()
...
plt.title('Matriz de Confusión LSTM 2007')
...
plt.title('Caídas Reales vs Predichas LSTM 2007')
...
plt.title('Caídas Reales vs Predichas (Febrero - Mayo 2020) LSTM 2007')
plt.legend()
plt.xlabel('Fecha')
...
plt.title("ACF de los residuos del modelo LSTM 2007")
plt.tight_layout()

# PACF de los residuos
plt.subplot(1, 3, 2)
plot_pacf(residuals, lags=30, method='ywm', ax=plt.gca())
plt.title("PACF de los residuos del modelo LSTM 2007")
plt.tight_layout()

plt.subplot(1, 3, 3)
sns.histplot(residuals, kde=True)
plt.title("Distribución de Residuos LSTM 2007")
plt.tight_layout()
plt.show()
...
plt.title('Permutation Feature Importance - LSTM 2007')
plt.tight_layout()
plt.show()
