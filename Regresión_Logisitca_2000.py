...
plt.title('Matriz de Confusión LR 2000')
...
plt.title('Importancia de las Feature - LR 2000')
...
plt.title('Caídas Reales vs Predichas LR 2000')
...
plt.title('Caídas Reales vs Predichas (Febrero - Mayo 2020) LR 2000')
plt.legend()
plt.xlabel('Fecha')
...
plt.title("ACF de los residuos del modelo LR 2000")
plt.tight_layout()

# PACF de los residuos
plt.subplot(1, 3, 2)
plot_pacf(residuals, lags=30, method='ywm', ax=plt.gca())
plt.title("PACF de los residuos del modelo LR 2000")
plt.tight_layout()

plt.subplot(1, 3, 3)
sns.histplot(residuals, kde=True)
plt.title("Distribución de Residuos LR 2000")
plt.tight_layout()
plt.show()
...
plt.title('Training vs Validation ROC AUC LR 2000')
plt.legend()
plt.grid(True)
plt.show()
